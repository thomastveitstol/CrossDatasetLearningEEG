...
def main():
    # Select dataset
    names = "HatlestadHall", "YulinWang", "Rockhill", "Miltiadous", "VanHees", "CAUEEG"

    # Loop through all names
    for name in names:
        # Get dataset
        available_datasets = (HatlestadHall, Rockhill, YulinWang, Miltiadous, MPILemon, VanHees, CAUEEG, OUS)
